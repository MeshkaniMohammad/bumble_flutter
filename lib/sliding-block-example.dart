import 'package:bumble_flutter/spring-simulation-chart.dart';
...
class _SlidingBlockExampleState extends State<SlidingBlockExample> with TickerProviderStateMixin {
  ...
  void _springBack() {
    ...
    SpringSimulation springSim = SpringSimulation(springDesc, blockAnimationController.value, 0, 0);
    blockAnimationController.animateWith(springSim);
    isSpringing = true;
  }

  void _recalculateDisplayedSpringSimulation() {
    SpringDescription desc = SpringDescription(mass: mass, stiffness: stiffness, damping: damping);
            ...
            child: Column(
              children: [
                Row(children: [
                  ...
                  SizedBox(width: 20),
                  RaisedButton(child: Text("SPRING BACK"), onPressed: _springBack),
                ]),
              ],
            ))
      ],
